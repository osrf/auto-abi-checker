...
COMMANDS = {  'sdf' =>
                       ...
                       "  -d [ --describe ]      Print the SDF description.\n" +
...
class Cmd
  ...
  def parse(args)
    ...
    opt_parser = OptionParser.new do |opts|
      ...
      opts.on('-d', '--describe', 'Print the SDF description') do |v|
        options['describe'] = v
      end
